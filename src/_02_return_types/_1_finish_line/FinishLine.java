	...
	public static void main(String[] args) {
		...
		//5. If the robot has crossed the finish line... 
			if (hasCrossedFinishLine()) {
				JOptionPane.showMessageDialog(null, "The robot finished. It went " + getTotalDistance());
			}
		...
		//7. Else use a pop up to say the robot did not finish and how far it went
				...
				JOptionPane.showMessageDialog(null, "The robot did not finish. It went " + getTotalDistance());
			}
	}
