...
public class DrumKit implements MouseListener {
    ...
    public void run() {
    	...
    	JFrame DKitFrame = new JFrame();
        //  Make the frame visible and
        // set its default close operation to JFrame.EXIT_ON_CLOSE
    	DKitFrame.setVisible(true);
    	DKitFrame.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        //  Set the title of the frame
    	
        //  Make a JPanel variable and initialize it using "new JPanel().
    	JPanel DKitPanel = new JPanel();
        //  Add the panel to the frame. (The panel is invisible.)
    	DKitFrame.add(DKitPanel);
    	...
    	DKitPanel.add(drumLabel);
    	DKitPanel.add(cymbalLabel);
